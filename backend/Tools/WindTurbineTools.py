...
from Tools.GeneralGeoTools import GetDepth, GetDistanceToShore, GetTimeList, MinDistanceSetPoints
...
def GetCostAndGenerationWindTurbine(InputDataPath, WindCostPath, WindTurbine, WindSpeedHeightsAvailable, SavePath=None, ResolutionKm=2):

    WindEnergy_pu, RatedPower, LatLong, WS_Hub, Depth, DistanceShore, TimeList, ResolutionKm=WindToEnergy(InputDataPath, WindTurbine, WindSpeedHeightsAvailable,ResolutionKm=ResolutionKm, SavePath=None)
