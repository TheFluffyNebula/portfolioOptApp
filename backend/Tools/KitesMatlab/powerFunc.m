...
xSite = [1,1];
uGeo = [11,3,7,0.4,18.879664767349897];
...
ratedPWR = uGeo(5); %Rated Power (in w)
uGeo(5)=ratedPWR;
...
% Tether
SFOTParams.CDthr = 1; 
SFOTParams.Diathr = 0.012; %Mary update
...
SFOTParams.NtimeSteps = 87; %Number of hours per time step
...
%Maximum Power is the RatedPower
