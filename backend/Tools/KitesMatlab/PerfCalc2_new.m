function [Power,aOpt,Fwing, idealPower] = PerfCalc2_new(SFOTParams,uGeo,uDep,vel)
...
Sthr = Diathr*(lthr/4);                                                           %0.25 tether length straight assummption
...
Fwing = 0.5*(idealPower/(vel/3))*(1e3);
